...
const services: Service[] = [
  ...
  },
  {
    ...
    image: serviceAdaptadoImage.src,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
  ...
  },
  {
    ...
    image: serviceAsistenciaImage.src,
    icon: (
      <svg viewBox="0 0 24 24" fill="none" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      ...
      <div className={styles.container}>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={styles.textPanel}>
                ...
                <Link href="/contacto" className={styles.serviceCtaBtn}>
                  {service.cta}
        ...
        <section className={styles.bottomCta}>
          ...
          <div className={styles.bottomCtaActions}>
            <Link href="/contacto" className={styles.btnPrimary}>Contactar ahora</Link>
            <Link href="/flota" className={styles.btnGhost}>Ver flota</Link>
          </div>
        </section>
